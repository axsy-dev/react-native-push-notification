...
class RNPushNotificationConfig {
  ...
  public String getChannelDescription() {
    try {
      ...
      Log.w(RNPushNotification.LOG_TAG,
          "Unable to find " + KEY_CHANNEL_DESCRIPTION + " in manifest. Falling back to default");
    }
    // Default
    return "";
  }
  ...
  public int getNotificationColor() {
    try {
      ...
      Log.w(RNPushNotification.LOG_TAG,
          "Unable to find " + KEY_NOTIFICATION_COLOR + " in manifest. Falling back to default");
    }
    // Default
    return -1;
  }
